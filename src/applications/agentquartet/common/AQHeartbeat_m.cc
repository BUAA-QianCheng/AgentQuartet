...
#include <sstream>
#include <memory>
#include "../../../applications/agentquartet/common/AQHeartbeat_m.h"
...
HeartbeatDescriptor::HeartbeatDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::Heartbeat)), "inet::FieldsChunk")
{
